...
import { ChevronLeft, CheckCircle2, Lock, Circle, Download } from "lucide-react";
 ...
 * O módulo com a próxima aula fica destacado em vermelho.
 */
export function ModuleSidebar({ course }: { course: CourseDetail }) {
  ...
  return (
    <div className="px-3 py-5">
      <Link
        href="/explorar"
        className="mb-5 flex items-center gap-1.5 px-2 text-[0.82rem] text-neutral-400 transition hover:text-white"
      >
      ...
      <div className="mt-5 border-t border-white/[0.07] pt-4">
        <button className="flex w-full items-center justify-center gap-2 rounded-lg bg-surface-1 px-3 py-2.5 text-[0.8rem] text-neutral-300 ring-1 ring-white/10 transition hover:bg-surface-2 hover:text-white">
